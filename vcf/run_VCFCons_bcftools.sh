...
MIN_COVERAGE=4
MIN_ALT_FREQ=0.5
SAMTOOLS=~/software_downloads/samtools-1.11/samtools
...
$PROG $REF $SAMPLE -c ${MIN_COVERAGE} -f ${MIN_ALT_FREQ} --input_depth ${SAMPLE}.aligned.bam.depth --input_vcf ${SAMPLE}.vcf --vcf_type bcftools
