...
ggsave(file.path(report.figdir,'Rplot.specimen_source.png'), dpi=200, width=4, height=2.5)
# -----------------------------------------
# plot geography
# -----------------------------------------
...
ggsave(file.path(report.figdir,'Rplot.geography_byContinent.png'), dpi=200, width=4, height=2.5)
...
ggsave(file.path(report.figdir,'Rplot.geography_asia.png'), dpi=200, width=4, height=2.5)
...
ggsave(file.path(report.figdir,'Rplot.geography_europe.png'), dpi=200, width=4, height=2.5)
...
ggsave(file.path(report.figdir,'Rplot.geography_na.png'), dpi=200, width=4, height=2.5)
...
if (all(FAIL_PASS_FIELDS %in% colnames(x))) {
  ...
  ggsave(file.path(report.figdir,'Rplot.pass_fail.png'), dpi=200, width=4.5, height=2.5)
  ...
  ggsave(file.path(report.figdir,'Rplot.count_Ns.png'), dpi=200, width=4.5, height=2.5)
  ...
  ggsave(file.path(report.figdir,'Rplot.count_segments.png'), dpi=200, width=4.5, height=2.5)
